...
{
    public class RangedDoublePropertyEditor : DoublePropertyEditor
    {
        public RangedDoublePropertyEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model)
        {
        }
