...
{
    public class RangedIntegerPropertyEditor : IntegerPropertyEditor
    {
        public RangedIntegerPropertyEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model)
        {
        }
