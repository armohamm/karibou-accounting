...
{
    public class RangedDecimalPropertyEditor : DecimalPropertyEditor
    {
        public RangedDecimalPropertyEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model)
        {
        }
