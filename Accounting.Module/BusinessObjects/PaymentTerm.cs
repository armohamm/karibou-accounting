...
namespace Accounting.Module.BusinessObjects
{
    ...
    [RuleCriteria("PaymentTerm_Party_RuleCriteria", DefaultContexts.Delete, "[<Party>][PaymentTerm = ^.Oid].Count() = 0", "Payment terms that are referenced by parties cannot be deleted. Update the party first, and then delete the payment term.")]
